...
//   pasos: number = 0;  // Variable para almacenar los pasos
//   aceleracion: number = 0;  // Variable para almacenar la aceleración

//   constructor(private motionService: MotionService) {}

//   ngOnInit(): void {
//     // Suscribirse al observable de pasos del servicio
//     this.motionService.pasos$.subscribe(pasos => {
//       this.pasos = pasos;  // Actualizar el contador de pasos
//     });

//     // Suscribirse al observable de aceleración del servicio
//     this.motionService.aceleracion$.subscribe(aceleracion => {
//       this.aceleracion = aceleracion;  // Actualizar la aceleración
//     });

//     // Iniciar el contador de pasos desde el servicio
...
//   // Función para detener el monitoreo de movimiento
//   detenerMonitoreo() {
//     this.motionService.stopMotion();
//   }
// }
